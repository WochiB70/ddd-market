...
public class AddRedeemItemController {
    ...
    public IdentifierId<Long> addRedeemItem(
        ...
        IdentifierId<Long> redeemItemId = addRedeemItemCmdHandler.handle(request.toCmd());
        createInventoryCmdHandler.handle(request.toCreateInventoryCmd(redeemItemId));
        return redeemItemId;
    }
}