...
import xyz.wochib70.domain.currency.cmd.ModifyCurrencyInfoCmd;

@Data
@Schema(description = "修改货币信息请求")
public class ModifyCurrencyInfoRequest {
    ...
    public ModifyCurrencyInfoCmd toCmd() {
        CurrencyInfo info = new CurrencyInfo(name, description);
        return new ModifyCurrencyInfoCmd(new DefaultIdentifierId<>(currencyId), info);
    }
}