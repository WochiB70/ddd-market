...
public class DeactivateCurrencyController {

    private final DeactivateCurrencyCmdHandler deactivateCurrencyCmdHandler;

    @PostMapping("/deactivate")
    @Transactional
    @Operation(summary = "停用货币", description = "停用指定的货币类型")
    @ApiResponses(value = {
