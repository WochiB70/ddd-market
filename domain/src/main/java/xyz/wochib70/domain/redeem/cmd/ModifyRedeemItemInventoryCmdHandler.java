...
@Service
public class ModifyRedeemItemInventoryCmdHandler {

    private final RedeemRepository redeemRepository;

    private final ApplicationEventPublisher eventPublisher;

    public void handle(ModifyRedeemItemInventoryCmd cmd) {
        Redeem redeem = redeemRepository.findByIdOrThrow(cmd.redeemId());
        redeem.modifyRedeemItemInventory(cmd.redeemItemId(), cmd.inventory());
